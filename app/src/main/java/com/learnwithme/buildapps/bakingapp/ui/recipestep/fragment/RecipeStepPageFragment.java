...
public class RecipeStepPageFragment extends Fragment implements ExoPlayer.EventListener {
    ...
    public static RecipeStepPageFragment newInstance(String description,
                                                     String videoUrl,
                                                     String imageUrl) {
    ...
    private void initializeMediaSession() {
        mediaSession = new MediaSessionCompat(getContext(), "RecipeStepPageFragment");
